...
describe Book do
  before :each do
    @book_one = Book.new 'Pedro', 'bad', Date.parse('12-07-2000')

    @book_two = Book.new 'Clara', 'good', Date.parse('12-07-1995')

    @book_three = Book.new 'Joka', 'good', Date.parse('12-07-2019')
